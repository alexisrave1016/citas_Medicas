...
const capturaDatos = () => {
    ...
    // }else{
    //     registroInicial= JSON.parse(localStorage.getItem('Citas'));
    //     registroInicial.unshift(registro);
    //     console.log(registroInicial);
    //     localStorage.setItem('Citas', JSON.stringify(registroInicial));
    // }

    citas.unshift(registro);
    // la primera Cita llama a q , o por que esta con mayuscula y en ningun lado esta asi
