...
const Login = () => {
  registrarce.addEventListener('click', () => {
    ...
    //no me funciona el evento clich , validar por q
...
//         `
  ...
  //  const envairRegistro= document.querySelector('button[id="enviarDatos"]');

  
  //  envairRegistro.addEventListener('click', elem => {
